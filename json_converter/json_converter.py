...
class JsonConverter:
    ...
    @staticmethod
    def _parse(
        tokens: list, index: int = 0
    ) -> (dict or list or bool or complex or int or str or None or float or bytes, int):
        """
    ...
    @staticmethod
    def _token_split_by(
        string: str, cur_index: int, flag: str, res: bool
    ) -> (bool or None, int):
        """
    ...
    def from_json(
        string: str,
    ) -> dict or list or bool or complex or int or str or None or float or bytes:
        """
    ...
    @staticmethod
    def to_json(
        obj: dict or bool or complex or int or str or None or float or bytes,
    ) -> str:
        """
