...
def test_iterable_to_dict() -> None:
    ...
    expected_b_arr = {
        "bytearray": [104, 101, 108, 108, 111, 32, 119, 111, 114, 108, 100, 33]
    }
...
def test_function_to_dict() -> None:
    ...
    expected_func = {
        "function": {
            ...
            "__globals__": {"math": {"module": {"name": "math"}}, "c": 42},
            "__defaults__": None,
        }
    }
...
def test_class_to_dict() -> None:
    ...
    expected_cls = {
        "class": {
            "name": "ExampleClass",
            "qualname": "ExampleClass",
            "bases": {"tuple": []},
            "attrs": {
                "__module__": "tests.test_intermediate_format_serializer",
                "static_value": 3,
                "__init__": {
                    "function": {
                        "__closure__": None,
...
def test_instance_of_class_to_dict() -> None:
    ...
    intermediate_instance = IntermediateFormatSerializer.instance_of_class_to_dict(
        instance
    )
                        ...
                        "print_value": {
                            "function": {
                                ...
                                "__code__": {
                                    ...
                                    "co_stacksize": 2,
                                    "co_flags": 67,
                                    "co_code": "74007c006a01830" "1010064005300",
                                    "co_consts": {"tuple": [None]},
                                    "co_names": {"tuple": ["print", "value"]},
                                    "co_varnames": {"tuple": ["self"]},
                                    "co_filename": location,
...
def test_format_to_function() -> None:
    ...
    func = IntermediateFormatSerializer.format_to_function(
        intermediate_func["function"]
    )
    expected_func = f
...
def test_format_to_module() -> None:
    ...
    module = IntermediateFormatSerializer.format_to_module(
...
def test_format_to_instance_of_class() -> None:
    ...
    instance = IntermediateFormatSerializer.format_to_instance_of_class(
        intermediate_instance["object"]
    )
